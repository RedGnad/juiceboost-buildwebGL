...
namespace Sample
{
    public class SettingsController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                Debug.LogWarning("[SettingsController] UIDocument or rootVisualElement is null!");
            }
        ...
        private void AddInfoItems()
        {
            ...
            if (_scrollContentContainer != null)
            {
        ...
        private async void UpdateClientIdInfoItem()
        {
            ...
            if (_clientIdInfoItem != null && _scrollContentContainer != null)
            {
        ...
        {
            if (_settingsView == null || _background == null || _settingsButton == null)
                return;
