...
var ASM_CONSTS = {
  4991552: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4991613: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4991677: function() {return Module.webglContextAttributes.powerPreference;},  
 4991735: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4991790: function($0) {performance.now = function() { return $0; };},  
 4991838: function($0) {performance.now = function() { return $0; };},  
 4991886: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _Initialize(parametersJsonPtr, callbackPtr) {
          ...
          import("https://cdn.jsdelivr.net/npm/@reown/appkit-cdn@1.7.1/dist/appkit.js").then(async (AppKit) => {
              ...
              (function() {  dynCall_v.call(null, callbackPtr); })();
          });
      }
  ...
  async function ExecuteCall(callFn, id, methodNameStrPtr, parameterStrPtr, callbackPtr) {
          if (!_appKitConfig) {
          ...
          try {
              ...
              if (result === undefined || result === null) {
                  (function(a1, a2, a3) {  dynCall_viii.apply(null, [callbackPtr, a1, a2, a3]); })(id, undefined, undefined);
                  return;
              }
              ...
              (function(a1, a2, a3) {  dynCall_viii.apply(null, [callbackPtr, a1, a2, a3]); })(id, resultStrPtr, undefined);
              _free(resultStrPtr);
          } catch (error) {
              ...
              (function(a1, a2, a3) {  dynCall_viii.apply(null, [callbackPtr, a1, a2, a3]); })(id, undefined, errorStrPtr);
              _free(errorStrPtr);
          }
      }
  async function _ModalCall(id, methodNameStrPtr, parameterStrPtr, callbackPtr) {
  ...
  function _ModalSubscribeState(callbackPtr) {
          _appKitConfig.modal.subscribeState(newState => {
              ...
              (function(a1) {  dynCall_vi.apply(null, [callbackPtr, a1]); })(dataStr);
              _free(dataStr);
          });
      }

  function _SetWalletAddressJS(walletPtr) {
  ...
  async function _ViemCall(id, methodNameStrPtr, parameterStrPtr, callbackPtr) {
          const callFn = async (appKitConfig, methodName, parameterObj) => {
  ...
  async function _WagmiCall(id, methodNameStrPtr, parameterStrPtr, callbackPtr) {
          const callFn = async (appKitConfig, methodName, parameterObj) => {
...
var asmLibraryArg = {
  ...
  "SetWalletAddressJS": _SetWalletAddressJS,
...
unexportedRuntimeFunction('SerializeJson', false);
unexportedRuntimeFunction('SerializeJson__user', false);
unexportedRuntimeFunction('ExecuteCall', false);
unexportedRuntimeFunction('ExecuteCall__user', false);
